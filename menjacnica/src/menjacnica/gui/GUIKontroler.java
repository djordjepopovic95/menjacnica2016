...
public class GUIKontroler {
	...
	public static void unesiKurs(String naziv, String skraceniNaziv, int spinnerSifra, String prodajni, String kupovni, String srednji) {
		try {
	...
	protected static void prikaziSveValute(JTable table, Menjacnica sistem) {
		MenjacnicaTableModel model = (MenjacnicaTableModel)(table.getModel());
